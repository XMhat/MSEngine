...
/* ------------------------------------------------------------------------- */
namespace IfCVarLib {                  // Start of module namespace
/* -- Includes ------------------------------------------------------------- */
...
CVI(TEXT_NOAUDIO, HIGHEST, CON_BLINPUT, cConsole->SetConsoleInputLines,
  size_t, TUINTEGERSAVE|PANY),
CVI(GRAPHICS, HIGHEST, CON_DISABLED, cConsole->CantDisableModified,
  bool, TBOOLEAN|PBOOT|PSYSTEM),
CVI(TEXT_NOAUDIO, HIGHEST, CON_CVSHOWFLAGS, cCVars->SetDisplayFlags,
  unsigned int, TUINTEGER|PANY),
CVI(GRAPHICS, HIGHEST, CON_BGCOLOUR, cConsole->TextBackgroundColourModified,
  uint32_t, TUINTEGERSAVE|PANY),
CVN(GRAPHICS, HIGHEST, CON_BGTEXTURE,
  TSTRING|CFILENAME|PSYSTEM),
CVN(GRAPHICS, HIGHEST, CON_FONT,
  TSTRING|CFILENAME|PSYSTEM),
CVI(GRAPHICS, HIGHEST, CON_FONTFLAGS, cConsole->ConsoleFontFlagsModified,
  unsigned int, TUINTEGER|PANY),
CVI(GRAPHICS, HIGHEST, CON_FONTCOLOUR, cConsole->TextForegroundColourModified,
  unsigned int, TUINTEGERSAVE|PANY),
CVI(GRAPHICS, HIGHEST, CON_FONTHEIGHT, cConsole->TextHeightModified,
  GLfloat, TUINTEGER|PSYSTEM),
...
CVN(GRAPHICS, HIGHEST, CON_FONTPCMAX,
  TUINTEGER|PSYSTEM),
CVI(GRAPHICS, HIGHEST, CON_FONTSCALE, cConsole->TextScaleModified,
  GLfloat, TUFLOATSAVE|PANY),
CVI(GRAPHICS, HIGHEST, CON_FONTSPACING, cConsole->TextLetterSpacingModified,
  GLfloat, TFLOAT|PSYSTEM),
CVI(GRAPHICS, HIGHEST, CON_FONTLSPACING, cConsole->TextLineSpacingModified,
  GLfloat, TFLOAT|PSYSTEM),
CVI(GRAPHICS, HIGHEST, CON_FONTWIDTH, cConsole->TextWidthModified,
  GLfloat, TUINTEGER|PSYSTEM),
...
/* -- Video cvars ---------------------------------------------------------- */
CVI(GRAPHICS, HIGHEST, VID_ALPHA, cDisplay->SetWindowTransparency,
  bool, TBOOLEAN|PSYSTEM),
...
CVI(GRAPHICS, HIGHEST, VID_CLEARCOLOUR, cFboMain->SetBackBufferClearColour,
  unsigned int, TUINTEGER|PSYSTEM),
CVI(GRAPHICS, HIGHEST, VID_DEBUG, cDisplay->SetGLDebugMode,
  bool, TBOOLEANSAVE|PANY),
...
CVI(GRAPHICS, HIGHEST, VID_BPP, cDisplay->SetForcedBitDepth,
  int, TUINTEGER|PANY),
CVI(GRAPHICS, HIGHEST, VID_HIDPI, cDisplay->HiDPIChanged,
  bool, TBOOLEANSAVE|PANY),
CVI(GRAPHICS, HIGHEST, VID_STEREO, cDisplay->SetStereoMode,
  bool, TBOOLEANSAVE|PANY),
CVI(GRAPHICS, HIGHEST, VID_NOERRORS, cDisplay->SetNoErrorsMode,
  bool, TBOOLEANSAVE|PANY),
CVI(GRAPHICS, HIGHEST, VID_SRGB, cDisplay->SRGBColourSpaceChanged,
  bool, TBOOLEANSAVE|PANY),
...
CVI(GRAPHICS, HIGHEST, VID_TEXFILTER, cFboMain->SetFilter,
  size_t, TUINTEGERSAVE|PANY),
CVI(GRAPHICS, HIGHEST, VID_VSYNC, cOgl->SetVSyncMode,
  int, TINTEGERSAVE|PANY),
CVI(GRAPHICS, HIGHEST, VID_GASWITCH, cDisplay->GraphicsSwitchingChanged,
  bool, TBOOLEANSAVE|PANY),
...
CVI(GRAPHICS, HIGHEST, VID_RDFBO, cOgl->SetFboDListReserve,
  size_t, TINTEGER|PSYSTEM|CUNSIGNED|PBOOT),
CVI(GRAPHICS, HIGHEST, VID_SSTYPE, cSShot->SetScreenShotType,
  size_t, TUINTEGERSAVE|PANY),
...
CVN(GRAPHICS, HIGHEST, WIN_HEIGHTMIN,
  TUINTEGER|PSYSTEM),
CVI(GRAPHICS, HIGHEST, WIN_MAXIMISED, cDisplay->SetMaximisedMode,
  bool, TBOOLEAN|PANY),
CVI(GRAPHICS, HIGHEST, WIN_MINIMISEAUTO, cDisplay->AutoIconifyChanged,
  bool, TBOOLEAN|PANY),
CVI(GRAPHICS, HIGHEST, WIN_POSX, cDisplay->SetXPosition,
  int ,TINTEGERSAVE|PANY),
CVI(GRAPHICS, HIGHEST, WIN_POSY, cDisplay->SetYPosition,
  int, TINTEGERSAVE|PANY),
