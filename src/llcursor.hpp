...
/* ========================================================================= */
namespace LLCursor {                   // Cursor namespace
/* -- Dependencies --------------------------------------------------------- */
using namespace ICursor::P;
/* ========================================================================= **
** ######################################################################### **
...
LLRSKTBEGIN(Codes)                     // Beginning of cursor codes
  ...
  LLRSKTITEMEX(GLFW_,RESIZE_EW,_CURSOR), LLRSKTITEMEX(GLFW_,RESIZE_NS,_CURSOR),
