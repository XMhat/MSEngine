...
{ /* -- Critical cvars ----------------------------------------------------- */
  ...
  /* -- Video cvars -------------------------------------------------------- */
  VID_ALPHA,        VID_API,             VID_AUXBUFFERS,      VID_BPP,
  VID_CONTEXT,      VID_CLEAR,           VID_CLEARCOLOUR,     VID_DBLBUFF,
  VID_DEBUG,        VID_FS,              VID_FSAA,            VID_FORWARD,
  VID_FSMODE,       VID_GAMMA,           VID_GASWITCH,        VID_HIDPI,
  VID_LOCK,         VID_MONITOR,         VID_NOERRORS,        VID_ORASPMAX,
  VID_ORASPMIN,     VID_ORHEIGHT,        VID_ORWIDTH,         VID_PROFILE,
  VID_QCOMPRESS,    VID_QLINE,           VID_QPOLYGON,        VID_QSHADER,
  VID_RCMDS,        VID_RDFBO,           VID_RDTEX,           VID_RELEASE,
  VID_RFBO,         VID_RFLOATS,         VID_ROBUSTNESS,      VID_SIMPLEMATRIX,
  VID_SRGB,         VID_SSTYPE,          VID_STEREO,          VID_SUBPIXROUND,
  VID_TEXFILTER,    VID_VSYNC,
  /* -- Window cvars ------------------------------------------------------- */
